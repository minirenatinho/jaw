...
const printTutorial = () => {
    ...
    ctx.fillRect(180, 130, 580, 300);
    ctx.fillStyle = "rgba(0, 0, 0, 0.3)";
    ctx.fillRect(190, 140, 560, 280);
...
const printScore = () => {
    ...
    ctx.fillText(topScore1, 18, 32);
    ctx.fillText(topScore2, 18, 47);
    ctx.fillText(topScore3, 18, 62);
    ctx.fillStyle = 'white';
...
const attChat = () => {
    ...
    //print writting text background
    ctx.fillStyle = 'black';
    
    ctx.font = 'bold 18px Courier';
    ctx.fillText('> '+command, 3, 552);

    //print writting text
    if (prompt) ctx.fillStyle = 'white';
